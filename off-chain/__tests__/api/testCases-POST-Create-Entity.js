...
const testCases = [
    ...
    // Security testing - SQL injection
    {
        ...
        url: '/api/{entity}',
        entity: validEntity,
        body: { createFields: { ...validBodyWithCreateFields.createFields, sellerPaymentPKH: '1 OR 1=1' } },
        token: validToken,
        expectedStatus: 200,
        expectedBody: {},
    },
    // Security testing - XSS
    {
        ...
        url: '/api/{entity}',
        entity: validEntity,
        body: { createFields: { ...validBodyWithCreateFields.createFields, sellerPaymentPKH: 'There are tags here: <script>alert("XSS")</script>, but they will be deleted' } },
        token: validToken,
        expectedStatus: 200,
        expectedBody: {},
    },
